...
public class DropSpot : MonoBehaviour ,IDropHandler
{
    public void OnDrop(PointerEventData eventData)
    {
        ...
        GameObject ObjectDroped = Instantiate(transform.parent.transform.parent.transform.parent.GetComponent<ListeItems>().listeallItems[itemdrag.GetComponent<Item>().ItemData.id].Objet3d, new Vector3(0, 10, 0), Quaternion.identity);
