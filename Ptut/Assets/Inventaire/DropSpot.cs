...
public class DropSpot : MonoBehaviour ,IDropHandler
{
    public void OnDrop(PointerEventData eventData)
    {
        ...
        GameObject ObjectDroped = Instantiate(ListAllItems.instance.listeallItems[itemdrag.GetComponent<Item>().ItemData.id].Objet3d, new Vector3(0, 10, 0), Quaternion.identity);
